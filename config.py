...
OWNER_ID = int(os.getenv("OWNER_ID", "7828753331")
OWNER_USERNAME = os.getenv("OWNER_USERNAME", "TFW_FOUNDER")
BOT_USERNAME = os.getenv("BOT_USERNAME", "VERONxMUSIC_BOT")
...
LOG_GROUP_ID = int(os.getenv("LOG_GROUP_ID", "-1002485775078"))
...
UPSTREAM_REPO = os.getenv("UPSTREAM_REPO", "https://github.com/WRITERDRO/Master")
